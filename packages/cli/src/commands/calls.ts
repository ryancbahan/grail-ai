import { analyze, registerLanguage, collectFiles, buildCallGraph, callsOf } from "@grail-ai/core";
...
export const calls: Command = {
  ...
  run: async (args, flags) => {
    ...
    output({
      file: args[1],
      name: args[2],
      calls: callsOf(allFiles, root.absolutePath, args[1], args[2], { transitive: flags.transitive, maxDepth: flags.depth }),
    });
  },
};
